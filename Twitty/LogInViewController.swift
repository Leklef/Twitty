...
class LogInViewController: UIViewController {
    ...
    @IBOutlet weak var logoHeightToOriginalConstraint: NSLayoutConstraint!
    ...
    override func viewDidLoad() {
        ...
        let color4 = UIColor(red: 244.0/255.0, green: 226.0/255.0, blue: 228.0/255.0, alpha: 1.0)
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        logoHeightToOriginalConstraint.isActive = false
